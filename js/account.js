nowave.controller('AccountCtrl', function($scope, $http, clientConfig, AnalyticsService) {
    'use strict';
    ...
    $scope.handleStripe = function(status, response) {
        ...
        if (!isStripeValid(response)) {
            ...
            $http({
                ...
                AnalyticsService.createProfile($scope.user);
                AnalyticsService.track('Account created');
