...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    /**
     * Use the right API keys depending on the environment (dev/prod)
     * https://github.com/gruntjs/grunt-contrib-copy
     */
    copy: {
      dev: {
        nonull: true,
        src: '<%= project.config %>/dev.js',
        dest: '<%= project.src %>/js/config-do-not-edit.js'
      },
      dist: {
        nonull: true,
        src: '<%= project.config %>/prod.js',
        dest: '<%= project.src %>/js/config-do-not-edit.js'
      }
    }
  });
